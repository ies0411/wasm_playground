var createModule = (() => {
  ...
  return function (createModule) {
    ...
    var wasmBinaryFile;
    if (Module['locateFile']) {
      wasmBinaryFile = 'findplane.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL('findplane.wasm', import.meta.url).toString();
    }
    ...
    var _intrinsicGetImageResolution = (Module['_intrinsicGetImageResolution'] = function () {
      return (_intrinsicGetImageResolution = Module['_intrinsicGetImageResolution'] = Module['asm']['z']).apply(
        null,
        arguments
      );
    });
    var _readPCD = (Module['_readPCD'] = function () {
      return (_readPCD = Module['_readPCD'] = Module['asm']['A']).apply(null, arguments);
    });
    var _decodePCD = (Module['_decodePCD'] = function () {
      return (_decodePCD = Module['_decodePCD'] = Module['asm']['B']).apply(null, arguments);
    });
    var _findPlane = (Module['_findPlane'] = function () {
      return (_findPlane = Module['_findPlane'] = Module['asm']['C']).apply(null, arguments);
    });
    ...
    var ___errno_location = (Module['___errno_location'] = function () {
      return (___errno_location = Module['___errno_location'] = Module['asm']['G']).apply(null, arguments);
    });
    var _emscripten_builtin_memalign = (Module['_emscripten_builtin_memalign'] = function () {
      return (_emscripten_builtin_memalign = Module['_emscripten_builtin_memalign'] = Module['asm']['H']).apply(
        null,
        arguments
      );
    });
